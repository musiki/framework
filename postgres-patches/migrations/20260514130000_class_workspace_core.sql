...
-- Canonical class workspace model.
-- This is additive: existing LiveClassResource, ResourceSession, and RoomSnapshot
-- remain available while adapters migrate the app to this model.
